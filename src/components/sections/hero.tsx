...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-900 dark:to-purple-900">
      ...
      {/* Gradient Orbs - Optimized with slower animations and will-change */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-400 rounded-full mix-blend-multiply filter blur-xl opacity-20" style={{ willChange: 'transform', animation: 'pulse 6s cubic-bezier(0.4, 0, 0.6, 1) infinite' }}></div>
      <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-purple-400 rounded-full mix-blend-multiply filter blur-xl opacity-20" style={{ willChange: 'transform', animation: 'pulse 7s cubic-bezier(0.4, 0, 0.6, 1) infinite 1s' }}></div>
      <div className="absolute bottom-1/4 left-1/3 w-96 h-96 bg-pink-400 rounded-full mix-blend-multiply filter blur-xl opacity-20" style={{ willChange: 'transform', animation: 'pulse 8s cubic-bezier(0.4, 0, 0.6, 1) infinite 2s' }}></div>
